...
data<-data[, c(1:5, grep("Liver.metabolomics", names(data)))]
...
setwd(wd)
write.table(results, file="R/Liver_metab_effects.csv", sep=",", row.names=F, col.names=names(results))
